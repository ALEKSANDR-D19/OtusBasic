...
![](https://github.com/ALEKSANDR-D19/OtusBasic/blob/main/Jpeg/lab7-8.PNG)
...
```
  ...
  * Включаем порты fa0/1 и fa0/3 на всех коммутатрах
...
![](https://github.com/ALEKSANDR-D19/OtusBasic/blob/main/Jpeg/lab7-9.PNG)


На коммутаторе S2 протокол STP в качестве порта корневого моста выбрал порт fa0/1, на коммутаторе S3 - fa0/3
Так произошло потому что протокол STP выбрал порт с наименьшим значением.
  ...
  * Вопросы
    ...
    Если стоимости портов и BID равны, для определения корневого моста используются приоритеты портов.
